    ...
    def __init__(self, model_name="llama-3.3-70b-versatile"):
        ...
        if presentation_mode == "on":
            self.prompt_template = ChatPromptTemplate.from_messages([
                ("system", 
                "You are a communications coach reviewing speech or talk, based on a transcription and provided audio metrics. For questions 3–6, provide only a rating (no explanation)."),
                ("user", 
                """
